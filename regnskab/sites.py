    ...
    def get_urls(self):
        ...
        return [
            ...
            url(r'^profile/search/$', views.ProfileSearch.as_view(),
                name='profile_search'),
            url(r'^images/stack/create/$',
                images.SheetImageStackCreate.as_view(),
                name='sheet_image_stack_create'),
            url(r'^images/sheet/create/$',
                images.SheetImageCreate.as_view(),
                name='sheet_image_create'),
